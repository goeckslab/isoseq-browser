...
from bokeh.models.widgets import Slider, TextInput, PreText, DataTable, TableColumn, CheckboxGroup, Button, RadioButtonGroup, CheckboxButtonGroup
...
def updateGene():
    ...
    sourceDict = getExonData(exonList)         # get the data of each isoform that can be directly used to plot
